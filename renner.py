...
planilha = pd.read_excel(r'C:\Users\rafae\OneDrive\Documentos\prog\coding\IB_organized\data\renner_data.xlsx')
...
def get_coordinates(row):
    address = f"{row['Location']}, {row['City']}, {row['State']}"
    try:
...
planilha.to_excel('output/renner_coord.xlsx', index=False)
